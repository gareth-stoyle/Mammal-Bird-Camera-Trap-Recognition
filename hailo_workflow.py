...
tflite_model_path = "/home/ges/Mammal-Bird-Camera-Trap-Recognition/models/model2023/EfficientNetV2.tflite"
...
# Directories
image_dir = "/home/ges/Mammal-Bird-Camera-Trap-Recognition/data/MOF"
yaml_dir = "/home/ges/Mammal-Bird-Camera-Trap-Recognition/data/MOF/md"

# Get images with bounding boxes
images_with_bboxes = get_all_images_with_bboxes(image_dir, yaml_dir)[:1024]
...
np.save("calib_set_500_float32.npy", calib_dataset)